window.initializeMapbox = (location, accessToken) => {
    ...
    var map = new mapboxgl.Map({
        ...
        center: [location.longitude, location.latitude], // Center map on the coordinates
        zoom: 12 // Zoom level
    });
...
function initializeMapboxWithRoute(locations, accessToken) {
    mapboxgl.accessToken =accessToken;
